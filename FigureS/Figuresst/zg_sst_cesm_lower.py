...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 17 21:52:03 2023
...
#print(lons)
time1 = d2['time'][:]   
tas = d2['Z3'][(time1.dt.month>=7)&(time1.dt.month<=8)&(time1.dt.year>=1979)&(time1.dt.year<=2020)][:,2,:,:]
...
np.save("/Users/fuzhenghang/Documents/大四上/热浪/中间数据/amip_Reg_cesmsst-z200-36yr850.npy",reg)
np.save("/Users/fuzhenghang/Documents/大四上/热浪/中间数据/amip_R_cesmsst-z200-36yr850.npy",R)
"""
reg = np.load("/Users/fuzhenghang/Documents/大四上/热浪/中间数据/amip_Reg_cesmsst-z200-36yr850.npy")
R = np.load("/Users/fuzhenghang/Documents/大四上/热浪/中间数据/amip_R_cesmsst-z200-36yr850.npy")
print(reg)
proj = ccrs.PlateCarree()  #中国为左
leftlon, rightlon, lowerlat, upperlat =(-180,180,5,65)
lon_formatter = cticker.LongitudeFormatter()
lat_formatter = cticker.LatitudeFormatter()
fig = plt.figure(figsize=(10,6),dpi=600)

levels = [np.arange(-18,18.001,3)]
...
ti = ['CESM2-CAM6: H200']
lab=[np.arange(-18,18.001,6),np.arange(-12,12.001,2)]
#la = ['dagpm/(W)']
for i in range(1):
