...
d2 = xr.open_dataset("/Users/fuzhenghang/Documents/ERA5/amip/olr.ensmean.amip.1880-2014_1deg.nc")
#print(d2.variables.keys())
lons = d2['lon']
lats = d2['lat']
#print(lons)
time1 = d2['time'][:]   
tas = d2['FLNT'][(time1.dt.month>=7)&(time1.dt.month<=8)&(time1.dt.year>=1979)&(time1.dt.year<=2020)]
...
for i in range(181):
    for j in range(360):
        corr[i,j],corrp[i,j] = pearsonr(pre1, tas[:,i,j])#days_map
